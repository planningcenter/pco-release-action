...
const FOOTER =
  '## 🚀 PCO-Release\n\nThis PR was automatically generated by pco-release-action.  Merging it will create a new release.\n\nTo change the version type, update the label to the appropriate type (`pco-release-patch`, `pco-release-minor`, or `pco-release-major`).'
...
async function buildBody(version: string): Promise<string> {
